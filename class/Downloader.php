...
class Downloader
{
  ...
  public function download(bool $audio_only, bool $outfilename = False, bool $vformat = False): void
  {
  ...
  public static function get_current_background_jobs(): array|null
  {
    $config = require dirname(__DIR__) . '/config/config.php';
  ...
  private function check_requirements($audio_only = False): bool
  {
  ...
  private function do_download($audio_only): void
  {
    $cmd = $this->config["bin"];
  ...
  private function do_info(): string|false|null
  {
